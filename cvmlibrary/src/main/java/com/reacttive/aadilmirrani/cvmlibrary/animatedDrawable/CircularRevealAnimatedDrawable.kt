...
class CircularRevealAnimatedDrawable(private val mAnimatedView: View, fillColor: Int, private var mReadyImage: Bitmap?) : Drawable(), Animatable {
    ...
    private var mCenterHeith: Float = 0.toFloat()
