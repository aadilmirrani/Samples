package com.reacttive.aadilmirrani.cvmlibrary.animatedDrawable
...
class CircularAnimatedDrawable(private val mAnimatedView: View, private val mBorderWidth: Float, arcColor: Int) : Drawable(), Animatable {
    ...
    companion object {
        ...
        private const val PROGRESS_ANIMATOR_DURATION = 200
